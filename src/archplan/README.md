...
ArchPlanLab (extends BaseWorld)
  ...
  │     │                            • 🏛 Mái = MÁI CHUẨN frustum chia tọa độ A–X (roof-lab + roof-preview WebGL + ops/ thư viện op Houdini-style: #1 resample.ts arc-length · #2 sweep.ts quét tiết diện parallel-transport; gốc bắt đầu mọi dạng mái — memory canonical-roof-base):
