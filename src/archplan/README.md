...
ArchPlanLab (extends BaseWorld)
  ...
  │     │                              KLMN (chiếu nóc↓đáy) → O–V (KLMN kéo dài cắt biên đáy). MÁI ĐAO (góc cong): A'B'C'D' NHẤC góc → MẶT mái LOFT cong (Coons) bám HIÊN cong 起翘 (giữa O–P phẳng y=0, chỉ góc vểnh) + 2 hip cong + nóc; solidify ĐỘ DÀY thuôn dần về góc (mỏng ở mũi) + lớp dày VÀNG (group riêng); CUỘN MŨI tầng 2 (quặp vào trong+lên, Đốt mũi/Cuộn mũi). KẾT CẤU: khung gỗ KLMNEFGH timber (inset = mặt ngoài trùng mép nóc) + 4 XÀ GÓC cong timber K→A' (thon dần về mũi, dưới mặt, ĐỐT+CONG RIÊNG: Đốt xà≤24/Cong xà). Marker trên đường cong: I1–I4 (giữa hip) · J1–J4 (giữa xà góc) · X1/Y1 (giữa cung hiên góc A) — đều chạm đỉnh mái đã cuộn. Peak HỞ đáy ngồi trên nóc base.
