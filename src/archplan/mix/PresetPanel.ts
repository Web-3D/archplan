...
function ensurePresetCss(): void {
  ...
  s.textContent =
    ...
    `.ap-mixpre{width:372px;max-height:80vh;overflow-y:auto;background:var(--mp-bg-1);` +
    ...
    // KHUNG PRESET — 10 ô = 5 cột × 2 HÀNG (NgQuan: 5 trên 5 dưới), ô vuông aspect-ratio 1
